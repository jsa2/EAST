function getResourceGraphSecurityAssessment (resourceId) {
    this.query = `securityresources | where type =~ "microsoft.security/assessments" 
...
// AssessmentsQueryBuilder.columnDefinitions.typeFullPath - END
    ...
    | join kind=leftouter (
        ...
        ) on assessmentKey, subscriptionId | where resourceId =~ "${resourceId}"
...
module.exports={getResourceGraphSecurityAssessment}